...
// Dos apps de GitHub reales conectables a la vez (Mariana, 2026-08-20): una
// bajo su cuenta personal, otra bajo el org de Imagine — cada una es su
// propio botón/Auth Profile en app/routers/oauth.py ("github_personal"/
// "github_imagine"), ambas contra la misma API real de GitHub.
